                  ...
                  builder: (context, state) {
                    ...
                    return Row(
                      ...
                      children: List.generate(4, (index) {
                        return _buildCodeInputBox(context, cubit, state, index);
                      }),
                    );
                  },
                ),
  ...
  Widget _buildCodeInputBox(BuildContext context, CodeVerificationCubit cubit,
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        onEditingComplete: () {
          if (state.controllers[index].text.isEmpty && index > 0) {
            FocusScope.of(context).requestFocus(state.focusNodes[index - 1]);
          }
        },
        onTap: () {
          state.controllers[index].selection = TextSelection.fromPosition(
            TextPosition(offset: state.controllers[index].text.length),
          );
        },
      ),
    );
